...
fun RBuilder.mTextField(
    ...
    setAttributes(
        this, autoComplete, autoFocus, defaultValue, disabled, error, fullWidth, helperText, id, label, margin,
...
fun RBuilder.mTextFieldMultiLine(
    ...
    setAttributes(
        this, null, autoFocus, defaultValue, disabled, error, fullWidth, helperText, id, label, margin,
