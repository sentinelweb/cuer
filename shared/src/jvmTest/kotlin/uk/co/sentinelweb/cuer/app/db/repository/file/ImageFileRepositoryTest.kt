...
class ImageFileRepositoryIntegrationTest {
    ...
    fun saveImage_local() = runBlocking {
        val file =
            "file://${platformOperation.currentDir().path}/../media/stock_photo/playlist/original/art-school-of-athens-1143741_1920.jpg"
    ...
    fun toLocalUri() = runBlocking {
        ...
        assertThat(localFileUri).isEqualTo("file://${sut._dir.path}/playlist.png")
        Unit
    }
}