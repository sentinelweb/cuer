...
class ItemRowView constructor(c: Context, a: AttributeSet?, def: Int = 0) : FrameLayout(c, a, def),
    ...
    private var _binding: ViewPlaylistRowBinding? = null
    private val binding get() = _binding ?: throw Exception("ViewPlaylistRowBinding not bound")
    ...
    override fun onFinishInflate() {
        ...
        _binding = ViewPlaylistRowBinding.bind(this)
