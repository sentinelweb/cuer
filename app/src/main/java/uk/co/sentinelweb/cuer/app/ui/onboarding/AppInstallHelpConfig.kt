        ...
        screens = listOf(
            Screen(
                ...
                lines = listOf(
                    ...
                    ActionResources(
                        label = "Browse the collection of philosophers and click to add them to your playlists.",
                        icon = null,
                        color = R.color.white
                    ),
                    ActionResources(
                        label = "You can watch all the playlists via chromecast or your device.",
                        icon = null,
                        color = R.color.white
                    ),
                    ActionResources(
            ...
            Screen(
                ...
                lines = listOf(
                    ...
                    ActionResources(
                        label = "Share playlists or videos.",
