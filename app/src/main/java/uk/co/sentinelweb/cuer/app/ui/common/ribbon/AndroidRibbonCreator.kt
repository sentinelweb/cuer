...
class AndroidRibbonCreator(
    ...
    override fun createRibbon(media: MediaDomain): List<RibbonModel> = listOf(
        ...
        RibbonModel(RibbonModel.Type.EDIT, res.getString(R.string.menu_edit), R.drawable.ic_edit),
        RibbonModel(RibbonModel.Type.SHARE, res.getString(R.string.menu_share), R.drawable.ic_share),
        RibbonModel(RibbonModel.Type.LIKE, res.getString(R.string.menu_like), R.drawable.ic_like_24),
        RibbonModel(RibbonModel.Type.COMMENT, res.getString(R.string.menu_comment), R.drawable.ic_comment),
        RibbonModel(RibbonModel.Type.LAUNCH, res.getString(R.string.menu_launch), R.drawable.ic_launch),
    )
